...
class CSFTrainer:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.agent = CSFAgent(
            ...
            lr=float(config['training']['lr']), # <--- ADDED float() CAST HERE
    ...
    def train(self):
        ...
        # Final save
        self.agent.save_models(self.config['paths']['save_dir'], self.timestep)
        self.normalizer.save(os.path.join(self.config['paths']['save_dir'], 'normalizer_final.pkl'))
    ...
    def _run_episode(self):
        ...
        # Reset environment - Gymnasium v5 returns observation directly
        ...
        while True:
            ...
            # Environment step - Gymnasium v5 API
    ...
    def _log_metrics(self, start_time):
        ...
        coverage = compute_state_coverage(self.state_positions[-10000:])  # Recent coverage
        ...
        metrics = {
            ...
            'episodes_per_hour': self.episode / (elapsed_time / 3600) if elapsed_time > 0 else 0,
        }
        
        # Add recent episode metrics if available
        ...
        # Console output
        print(f"Timestep: {self.timestep:6d} | "
    ...
    def _evaluate(self):
        ...
        try:
            ...
            skill_fig = self.visualizer.visualize_skills(
                self.agent, self.env, 
                num_skills=8, num_steps=200
            )
            
            skill_fig.savefig(
                os.path.join(self.config['paths']['log_dir'], f"skills_{self.timestep}.png"),
                dpi=150, bbox_inches='tight'
            )
            plt.close(skill_fig) # <--- CORRECTED LINE
        ...
        # Create separate evaluation log entry
    ...
    def _save_final_metrics(self):
        ...
        metrics_path = os.path.join(self.config['paths']['save_dir'], "final_metrics.pkl")
        ...
        print(f"Final state coverage: {compute_state_coverage(self.state_positions)}")
